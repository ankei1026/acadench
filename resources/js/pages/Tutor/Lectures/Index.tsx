...
interface TutorLecturesPageProps {
    lectures: LectureRow[];
    tutor_id: string;
}
                ...
                {lectures.length > 0 ? (
                                ...
                                <Card key={lecture.lecture_id} className="border-amber-200 bg-white shadow-md transition-all hover:shadow-lg">
                                    ...
                                    <CardContent className="space-y-3">
                                        ...
                                        <div className="flex items-center gap-2 text-sm">
                                            ...
                                            <span className="text-gray-600">Lecture ID:</span>
                                            <span className="font-mono text-xs font-medium text-gray-900">{lecture.lecture_id}</span>
                                        </div>
                    ...
                    <div className="flex flex-col items-center justify-center rounded-xl border border-amber-200 bg-amber-50/50 p-12">
                        ...
                        <p className="mt-2 text-center text-gray-600">
                            Lectures will appear here once you're assigned to bookings.
                        </p>
                    </div>
                )}
